...
.blobio-vip-plus-time {
  ...
  color: #f4fff6;
  font-size: clamp(17.91px, calc(var(--blobio-vip-plus-height, 106px) * 0.1791), 35.82px);
  font-weight: 900;
  line-height: 1;
...
#chat .blobio-chat-vip-plus-tag.is-admin-combined {
  text-decoration: none !important;
  text-shadow: 0 0 6px rgba(255, 248, 204, 0.74), 0 0 11px rgba(255, 190, 47, 0.72) !important;
}
