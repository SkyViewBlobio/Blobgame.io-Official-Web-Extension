...
export const HUD_INFO_BOOSTER_DURATION_COLOR_MODES = [
  ['simple', 'Simple'],
  ['solid', 'Solid'],
];
...
export function normalizeHudInfoSettings(settings = {}) {
  ...
  return {
    ...
    boosterDurationMode: normalizeMode(
      source.boosterDurationMode,
      HUD_INFO_BOOSTER_DURATION_COLOR_MODES,
      DEFAULT_HUD_INFO_SETTINGS.boosterDurationMode,
    ),
    ...
    boosterMergeColor: normalizeColor(source.boosterMergeColor, DEFAULT_HUD_INFO_SETTINGS.boosterMergeColor),
    boosterMergeAlpha: normalizeAlpha(source.boosterMergeAlpha, DEFAULT_HUD_INFO_SETTINGS.boosterMergeAlpha),
    boosterSpeedColor: normalizeColor(source.boosterSpeedColor, DEFAULT_HUD_INFO_SETTINGS.boosterSpeedColor),
    boosterSpeedAlpha: normalizeAlpha(source.boosterSpeedAlpha, DEFAULT_HUD_INFO_SETTINGS.boosterSpeedAlpha),
    boosterVirusColor: normalizeColor(source.boosterVirusColor, DEFAULT_HUD_INFO_SETTINGS.boosterVirusColor),
    boosterVirusAlpha: normalizeAlpha(source.boosterVirusAlpha, DEFAULT_HUD_INFO_SETTINGS.boosterVirusAlpha),
...
export function readHudInfoSettings(storage) {
  return normalizeHudInfoSettings({
    ...
    boosterMergeColor: storage?.getItem?.(HUD_INFO_KEYS.boosterMergeColor),
    boosterMergeAlpha: storage?.getItem?.(HUD_INFO_KEYS.boosterMergeAlpha),
    boosterSpeedColor: storage?.getItem?.(HUD_INFO_KEYS.boosterSpeedColor),
    boosterSpeedAlpha: storage?.getItem?.(HUD_INFO_KEYS.boosterSpeedAlpha),
    boosterVirusColor: storage?.getItem?.(HUD_INFO_KEYS.boosterVirusColor),
    boosterVirusAlpha: storage?.getItem?.(HUD_INFO_KEYS.boosterVirusAlpha),
...
export function saveHudInfoSettings(storage, settings) {
  ...
  try {
    ...
    storage?.setItem?.(HUD_INFO_KEYS.boosterMergeColor, next.boosterMergeColor);
    storage?.setItem?.(HUD_INFO_KEYS.boosterMergeAlpha, String(next.boosterMergeAlpha));
    storage?.setItem?.(HUD_INFO_KEYS.boosterSpeedColor, next.boosterSpeedColor);
    storage?.setItem?.(HUD_INFO_KEYS.boosterSpeedAlpha, String(next.boosterSpeedAlpha));
    storage?.setItem?.(HUD_INFO_KEYS.boosterVirusColor, next.boosterVirusColor);
    storage?.setItem?.(HUD_INFO_KEYS.boosterVirusAlpha, String(next.boosterVirusAlpha));
