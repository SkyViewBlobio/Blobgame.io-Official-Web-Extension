...
export function pageJellyShaderBootstrap(initialSettings, pageWindow = globalThis) {
  ...
  win.__blobioJellyShaderDebug = debugReport;
  win.BlobioJellyShaderDebug = debugReport;
