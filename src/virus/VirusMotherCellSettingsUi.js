...
export class VirusMotherCellSettingsUi {
  ...
  create() {
    ...
    this.elements = {
      ...
      colorInput: menu.querySelector('.blobio-virus-png-color-input'),
      colorSwatch: menu.querySelector('.blobio-virus-png-color-swatch'),
      alphaInput: menu.querySelector('.blobio-virus-png-alpha-input'),
      alphaValue: menu.querySelector('.blobio-virus-png-alpha-value'),
  ...
  createHeaderRow() {
    ...
    textLabel.textContent = 'Virus/Mothercell glow';
  ...
  createDropdownMenu() {
    ...
    canvas.width = 256;
    canvas.height = 256;
    canvas.setAttribute('aria-label', 'Selected virus PNG preview');
    preview.appendChild(canvas);
    menu.appendChild(preview);

    const pngSection = this.document.createElement('div');
    pngSection.classList.add('blobio-virus-section', 'blobio-virus-png-section');
    const pngTitle = this.document.createElement('div');
    pngTitle.classList.add('blobio-virus-section-title');
    pngTitle.textContent = 'PNG';
    pngSection.appendChild(pngTitle);
    ...
    colorSwatch.classList.add('blobio-virus-color-swatch', 'blobio-virus-png-color-swatch');
    const colorInput = this.document.createElement('input');
    colorInput.type = 'color';
    colorInput.classList.add('blobio-virus-color-input', 'blobio-virus-png-color-input');
    colorInput.setAttribute('aria-label', 'Virus PNG color');
    ...
    alphaInput.classList.add('blobio-virus-alpha-input', 'blobio-virus-png-alpha-input');
    const alphaValue = this.document.createElement('span');
    alphaValue.classList.add('blobio-virus-alpha-value', 'blobio-virus-png-alpha-value');
    alphaControl.append(alphaTitle, alphaInput, alphaValue);

    controls.append(colorControl, alphaControl);
    pngSection.appendChild(controls);

    const maskList = this.document.createElement('div');
    maskList.classList.add('blobio-virus-mask-list');
    maskList.setAttribute('aria-label', 'Virus PNG masks');
    ...
    pngSection.appendChild(maskList);
    ...
    pngSection.appendChild(rotateRow);
    menu.appendChild(pngSection);
