export const PARTNER_LINK_MATCH = /iogames\.space|iogames\.live|io-games\.zone|silvergames\.com|crazygames\.com/i;
export const FAILED_VIRAL_FRAME_MATCH = /viral\.iogames\.space/i;
export const OTHER_GAME_NAMES = ['Viper', 'Hexa'];
